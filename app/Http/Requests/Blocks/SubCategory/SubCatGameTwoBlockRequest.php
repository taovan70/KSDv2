...
//            'answer_data.*.is_correct' => 'required|boolean',
            'photo_path_one' => 'nullable|image|max:4096',
            'photo_path_two' => 'nullable|image|max:4096',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'photo_path_one.image' => __('validation.common.image'),
            'photo_path_two.image' => __('validation.common.image'),
