 ...
 */
class AdvPageCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\AdvPage::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/adv-page');
        CRUD::setEntityNameStrings(__('models.adv-page_possessive_case'), __('models.adv-pages'));
    }
    ...
    {
        CRUD::column('name')->label(__('table.name'))->limit(100);
        CRUD::column('slug')->label(__('table.slug'))->limit(100);
