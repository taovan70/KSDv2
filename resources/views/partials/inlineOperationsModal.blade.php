    ...
    <script>
        ...
        $(document).ready(function() {
          ...
          const translateObjectEN = {
            ...
            article_one_id:'Article one',
            article_two_id:'Article two',
            article_three_id:'Article three',
            article_four_id:'Article four',
            article_five_id:'Article five',
            article_six_id:'Article six',
            content : 'Content',
          ...
          const translateObjectRU = {
            ...
            article_four : 'Статья четвертая',
            article_one_id : 'Статья первая',
            article_two_id : 'Статья вторая',
            article_three_id : 'Статья третья',
            article_four_id : 'Статья четвертая',
            article_five_id : 'Статья пятая',
            article_six_id : 'Статья шестая',
            content : 'Контент',
