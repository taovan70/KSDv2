            ...
            @if ( $crud->buttons()->where('stack', 'top')->count() ||  $crud->exportButtons())
              <div class="d-print-none {{ $crud->hasAccess('create')?'with-border':'' }}">
                  <div class="d-print-none with-border">
                      <a href="/admin/make-article" class="btn btn-primary" data-style="zoom-in"><span class="ladda-label"><i class="la la-plus"></i>{{__('table.add')}} {{mb_strtolower(__('table.articles_accusative'))}}</span></a>
                  </div>
              </div>
            @endif
          </div>
